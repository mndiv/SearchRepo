...
public class TestDb extends AndroidTestCase {
    ...
    public void testLocationTable() {
        ...
        ContentValues testValues = com.iloveandrroid.divya.searchrepo.data.TestUtilities.createRepositoryValues();
        ...
        // query if you like)
        com.iloveandrroid.divya.searchrepo.data.TestUtilities.validateCurrentRecord("Error: Location Query Validation Failed",
                cursor, testValues);
