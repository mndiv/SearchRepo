 ...
 */
public class RepoWidgetIntentService extends RemoteViewsService {
    ...
    public RemoteViewsService.RemoteViewsFactory onGetViewFactory(Intent intent) {
        return new RemoteViewsService.RemoteViewsFactory() {
            ...
            public RemoteViews getViewAt(int position) {
                ...
                Log.v("RepoWidgetIntentService","repoName : " + repoName );
                ...
                Uri RepoUri = RepoContract.RepoEntry.CONTENT_URI;
