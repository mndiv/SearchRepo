package com.iloveandrroid.divya.searchrepo.sync;
...
/**
 * Manages "Authentication" to Repo's backend service.  The SyncAdapter framework
 ...
 */
public class RepoAuthenticator extends AbstractAccountAuthenticator {
    public RepoAuthenticator(Context context) {
        super(context);
    }
