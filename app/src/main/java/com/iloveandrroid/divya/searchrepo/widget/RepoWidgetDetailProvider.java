...
import com.iloveandrroid.divya.searchrepo.DetailActivity;
...
public class RepoWidgetDetailProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        //context.startService(new Intent(context, RepoWidgetRemoteViewsService.class));
        ...
        private void setRemoteAdapter(Context context, @NonNull final RemoteViews views) {
            views.setRemoteAdapter(R.id.widget_list,
                    new Intent(context, com.iloveandrroid.divya.searchrepo.widget.RepoWidgetRemoteViewsService.class));
        }
